 ...
 * Same gradient sweep as every sibling app's ShimmerText so the animated
 * title reads as the same brand.
 */
import { motion } from 'motion/react';
import { cn } from '@/lib/utils';

export default function ShimmerText({ text = 'Text Shimmer', className }: { text?: string; className?: string }) {
  return (
    <motion.span
